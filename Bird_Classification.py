...
# !streamlit run "C:\\Users\\praks\\Downloads\\Bird_Species_Classification_Streamlit-master\\Bird_Species_Classification_Streamlit-master\\Bird_Classification.py"
...
model = load_model('C:\\Users\\praks\\Downloads\\Bird_Species_Classification_Streamlit-master\\Bird_Species_Classification_Streamlit-master\\BC.h5', compile=False)
...
descriptions_path = 'C:\\Users\\praks\\Downloads\\Bird_Species_Classification_Streamlit-master\\Bird_Species_Classification_Streamlit-master\\Birds_description\\{}.txt'
...
def processed_img(img_path):
    ...
    # Load description
    with open(descriptions_path.format(bird_species), 'r') as file:
        description = file.read()
    
    return bird_species, description

def run():
    img1 = Image.open('C:\\Users\\praks\\Downloads\\Bird_Species_Classification_Streamlit-master\\Bird_Species_Classification_Streamlit-master\\meta\\logo1.png')

    img1 = img1.resize((350,350))
    st.image(img1,use_column_width=False)
    st.title("Birds Species Classification")
    st.markdown('''<h4 style='text-align: left; color: #d73b5c;'>* Dataset is based on 525 Bird Species</h4>''',
                unsafe_allow_html=True)

    img_file = st.file_uploader("Choose an Image of Bird", type=["jpg", "png"])
    if img_file is not None:
        st.image(img_file,use_column_width=False)
        save_image_path = 'C:\\Users\\praks\\Downloads\\Bird_Species_Classification_Streamlit-master\\Bird_Species_Classification_Streamlit-master\\upload_images'+img_file.name
        with open(save_image_path, "wb") as f:
            f.write(img_file.getbuffer())

        if st.button("Predict"):
            bird_species, description = processed_img(save_image_path)
            st.success("Predicted Bird Species: "+bird_species)
